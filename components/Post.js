            ...
            <div className="md:max-w-[300px] sm:flex-grow sm:justify-center sm:items-center bg-white rounded-lg border border-gray-200 shadow-md ">
                ...
                <div className="p-5">
                    ...
                    <Link href={`posts/${post.slug.current}`} >
                        <div className="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
                            Read more
